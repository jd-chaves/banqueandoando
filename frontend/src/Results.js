    ...
    return(
      <div>
        <Card
          ...
          actions={[<button type="button" className="btn btn-info " data-toggle="modal"  data-target={this.id}><span className="glyphicon glyphicon-plus"></span></button>, <button type="button" className="btn btn-info " data-toggle="modal" data-target={this.idr}><span className="glyphicon glyphicon-pencil"></span></button>]}
          >
